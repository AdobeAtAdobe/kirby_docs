...
|**S2**|Data that can be used to determine a broadly defined geofence area.|*S1**|Data specifying latitude and longitude that can be used to determine the precise location of a device.|
