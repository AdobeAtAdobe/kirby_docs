...
The true power of Query Service is revealed when queries are used to generate datasets in the data lake to be used as input into more queries or in other services like Data Science Workspace, Profile Service, or Analysis Workspace. 
...
. **Important:** In a live implementation you must apply Data Governance labels after the dataset is created. 
