...
This article provides steps to set up and configure the Amazon S3 connector using API calls. For further details you can refer to - [Swagger Documentation](../../../../../swagger-specs/partner-connectors-api.yaml)
