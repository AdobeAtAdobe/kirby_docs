# Explore your Customer Success system using the Flow Service API

Flow Service is used to collect and centralize customer data from various disparate sources within Adobe Experience Platform. The service provides a user interface and RESTful API from which all supported sources are connectable.

This tutorial uses the Flow Service API to explore Customer Success (CS) systems and includes the following steps:
...
* [Salesforce Service Cloud](./salesforce-service-cloud-api-tutorial.md)
...
*   `{BASE_CONNECTION_ID}`: The ID of the base connection for your CS system.
