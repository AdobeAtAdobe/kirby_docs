# Collect cloud storage data using APIs

This tutorial covers the steps for retrieving data from a third party cloud storage and bringing them in to Platform through source connectors and APIs. The steps involved include:
