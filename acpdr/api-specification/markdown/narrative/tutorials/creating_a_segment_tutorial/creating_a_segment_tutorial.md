...
See [Develop a Segment Definition](api-specification/markdown/narrative/technical_overview/unified_profile_architectural_overview/unified_profile_architectural_overview.md#develop-a-segment-definition) in the [Unified Profile Overview](api-specification/markdown/narrative/technical_overview/unified_profile_architectural_overview/unified_profile_architectural_overview.md), or go straight to the [API reference for Unified Profile Segment Definitions API](acpdr/swagger-specs/profile-segment-definitions-api.yaml).
...
For more details, visit the section on covering how to [create a segment job](api-specification/markdown/narrative/technical_overview/unified_profile_architectural_overview/unified_profile_architectural_overview.md#create-a-segment-job) in the [Unified Profile Overview](api-specification/markdown/narrative/technical_overview/unified_profile_architectural_overview/unified_profile_architectural_overview.md).
...
For directions, see [Export Your Audience](api-specification/markdown/narrative/technical_overview/unified_profile_architectural_overview/unified_profile_architectural_overview.md#export-your-audience) in the [Unified Profile Overview](api-specification/markdown/narrative/technical_overview/unified_profile_architectural_overview/unified_profile_architectural_overview.md). 

Your audience can then be accessed using the [Data Access API](api-specification/markdown/narrative/technical_overview/data_access_architectural_overview/data_access_architectural_overview.md).
