...
After the ingestion is complete, use the Profile Access API to access your Profile data. 
...
__Example UPS request - Get ExperienceEvents for a Unified Profile:__
...
__Example Unified Profile request - Create a new Definition:__
...
__Example request to create a Preview Job:__
...
__Example Unified Profile request - Run an Export Job:__
