...
With the `viewId`, you are able to use the Data Access SDK to read data. Data Access SDK is an official SDK provided by Platform foundation to read any data present inside a valid DataSet. For more information on using the Data Access SDK, [see samples](https://git.corp.adobe.com/experience-platform/data-access-sdk-sample), [see the project on GitHub](https://git.corp.adobe.com/experience-platform/data-access-sdk), or contact the SDK owner,  Imtiaz Ahmed ([imahmed@adobe.com] [mailto:imahmed@adobe.com]). 
