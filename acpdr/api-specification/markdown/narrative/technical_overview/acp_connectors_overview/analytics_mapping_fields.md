...
To learn more about performing this transformations using Query Service, please visit the [Adobe-defined functions](../../../../../end-user/markdown/query-service/qs-sql-functions.md) documentation.
