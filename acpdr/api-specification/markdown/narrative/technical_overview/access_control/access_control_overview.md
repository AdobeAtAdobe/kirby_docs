...
For more information about sandboxes in Experience Platform, please refer to the [sandboxes overview](../sandboxes_overview.md).

### Access to sandboxes

Access to sandboxes is managed through product profiles. For detailed steps on how to enable access to a sandbox for a product profile, see the [access control user guide](access_control_user_guide.md).
...
By reading this guide, you have been introduced to the main principles of access control in Experience Platform. You can now continue to the [access control user guide](access_control_user_guide.md) for detailed steps on how use the Admin Console to create product profiles and assign permissions for Platform.