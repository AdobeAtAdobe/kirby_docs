...
Adobe Experience Cloud provides GDPR-ready JavaScript APIs for data controllers. Use the Adobe Privacy JavaScript library to retrieve all the IDs generated by the Adobe Experience Cloud libraries for a specific domain.
