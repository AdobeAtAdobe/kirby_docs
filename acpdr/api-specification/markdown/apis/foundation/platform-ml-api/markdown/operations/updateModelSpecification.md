...
<a name="updatemodelspecification"></a>
### Update a model specification
```
PUT /modelSpecifications/{modelSpecificationId}
```


#### Description
Updates a specific model specification
...
|**FormData**|**modelSpecification**  <br>*optional*|Model specification object that needs to be updated|string|
