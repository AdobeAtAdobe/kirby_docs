...
<a name="deletetrainedmodels"></a>
### Delete all trained models for provided modelInstanceId
```
...
#### Description
Deletes all trained models for provided modelInstanceId
...
|**Query**|**modelInstanceId**  <br>*required*|The modelInstanceId for which trained models should be deleted|string|
