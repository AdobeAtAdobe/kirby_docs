...
<a name="deletetrainingmodeltask"></a>
### Deletes a model task
```
DELETE /taskQueues/modelProcessing/tasks
```


#### Description
Deletes a training model task
...
|**Query**|**modelInstanceId**  <br>*required*|The modelInstanceId for which a training model task should be deleted|string|
