...
<a name="createmodeltranscoding"></a>
### Creates a model transcoding
```
...
*Name* : model  
*Flags* : required  
*Type* : [ModelTranscoding](../definitions/ModelTranscoding.md#modeltranscoding)
...
|---|---|---|
|**201**|Creation successful  <br>**Headers** :   <br>`Location` (string) : URL indicating the location of the created Model resource.|[ModelTranscoding](../definitions/ModelTranscoding.md#modeltranscoding)|
