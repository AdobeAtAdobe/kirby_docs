...
<a name="retrieveinsight"></a>
### Returns Insight by id
```
...
|**Path**|**insightId**  <br>*required*|The identifier of the Sensei Insight|string|
...
|---|---|---|
|**200**|Insight object|[Insight](../definitions/Insight.md#insight)|
