...
<a name="retrievemodeltranscoding"></a>
### Returns a Model Transcoding by Id
```
...
|**Path**|**modelTranscodingId**  <br>*required*|The identifier of the transcoded model artifact|string|
...
|---|---|---|
|**200**|Returns the Model object|[ModelTranscoding](../definitions/ModelTranscoding.md#modeltranscoding)|
...
##### Request path
```
/models/string/transcodings/string
```
