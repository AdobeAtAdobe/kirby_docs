...
<a name="retrieveexperimentrun"></a>
...
|---|---|---|
|**200**|Returns the Run status and info|[ExperimentRun](../definitions/ExperimentRun.md#experimentrun)|
...
##### Request path
```
/experiments/string/runs/string
```
