...
<a name="connectionpatchrequest"></a>
...
|**dule**  <br>*optional*|DULE labels.  <br>**Example** : `"object"`|[dule](#connectionpatchrequest-dule)|
...
|**statsCache**  <br>*optional*|Cached statistics for this connection. Not to be used for transactionally sensitive workflows, as this may be outdated or incorrect at times. These values cannot be submitted to Catalog.  <br>**Example** : `"object"`|[statsCache](#connectionpatchrequest-statscache)|
...
<a name="connectionpatchrequest-dule"></a>
**dule**
...
<a name="connectionpatchrequest-frequency"></a>
**frequency**
