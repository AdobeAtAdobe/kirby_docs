...
|**connectionId**  <br>*optional*|Foreign key to the Connection this DataSet originates from. This is an immutable attribute and once created, it cannot be updated through PUT or PATCH requests.  <br>**Example** : `"string"`|string|
|**connectorId**  <br>*optional*|Foreign key to the Connector this DataSet originates from. Template DataSets are tied to Connectors and not Connections. This is an immutable attribute and once created, it cannot be updated through PUT or PATCH requests.  <br>**Example** : `"string"`|string|
...
|**dule**  <br>*optional*|DULE labels.  <br>**Example** : `"object"`|[dule](#datasetrequest-dule)|
...
|**fileDescription**  <br>*optional*|Metadata describing the DataSetFiles associated with this DataSetView.  <br>**Example** : `"object"`|[fileDescription](#datasetrequest-filedescription)|
...
|**namespace**  <br>*optional*|One of the registered platform acronyms that identify the platform. This is an immutable attribute and once created, it cannot be updated through PUT or PATCH requests.  <br>**Example** : `"string"`|enum (AA, AAM, AEM, AC, AT, AMO, PT, AS, AMC, ACP)|
...
|**statsCache**  <br>*optional*|Cached statistics for this data set. These values cannot be submitted to Catalog.  <br>**Example** : `"object"`|[statsCache](#datasetrequest-statscache)|
