...
<a name="deletemlinstances"></a>
### Delete ML instances for engineId
```
DELETE /mlInstances
```
...
#### Description
Deletes all ML instances for provided engineId
...
|**Query**|**engineId**  <br>*required*|The engineId for which ML instances should be deleted|string|
